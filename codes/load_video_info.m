...
%   http://www.isr.uc.pt/~henriques/
	...
	video_path = [base_path video '/'];  % 'sequence/Woman/'
...
%  	filename = [video_path video '_gt' suffix '.txt'];
	...
	target_sz = [ground_truth(1,4), ground_truth(1,3)];  % [w, h]
	pos = [ground_truth(1,2), ground_truth(1,1)] + floor(target_sz/2);   % [y_center, x_center]
